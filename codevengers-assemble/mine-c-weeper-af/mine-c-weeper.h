 ...
 *
 * NOTE: Even if this function will be in assembly language, observe that it is still declared in the .h file
 *       so that the C compiler knows how it interacts with the C code.
 *
 *       In effect, short of the comments, this .h file is _identical_ to the original.
 */
